...
import { loadResourcesFromCollections, filterResources, validateOutputDirectory, LoadedResource } from './export-common';
...
describe('export-common', () => {
    ...
    describe('validateOutputDirectory', () => {
        it('should create directory if it does not exist', () => {
            ...
            expect(fs.mkdirSync).toHaveBeenCalledWith('/dist/export', { recursive: true });
        });
    ...
    describe('loadResourcesFromCollections', () => {
        it('should load resources from multiple collections', () => {
            ...
            vi.spyOn(fs, 'existsSync').mockImplementation((p) => {
                if (typeof p === 'string') {
                    return p.includes('translations') || p.endsWith(RESOURCE_ENTRIES_FILENAME) || p.endsWith(TRACKER_META_FILENAME) || p === '/libs/core' || p === '/apps/app';
                }
                return false;
            });
