...
- **CLI** (`apps/cli`): Commands for init, add-collection, delete-collection, add-resource, edit-resource, delete-resource, move, normalize, bundle, export, import, validate, find-similar, glossary, install-skill. Supports both interactive (TTY) and non-interactive (CI/CD) modes.
