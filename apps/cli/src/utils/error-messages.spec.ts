...
describe('ErrorMessages', () => {
  describe('Configuration Errors', () => {
    ...
    it('should provide config invalid message', () => {
      expect(ErrorMessages.CONFIG_INVALID).toBe(
  ...
  describe('Collection Errors', () => {
    ...
    it('should provide no collections available message', () => {
      expect(ErrorMessages.NO_COLLECTIONS_AVAILABLE).toBe(
  ...
  describe('Option Errors', () => {
    ...
    it('should provide non-interactive missing options message', () => {
      expect(
        ErrorMessages.MISSING_OPTIONS_NON_INTERACTIVE(['format', 'output']),
      ).toBe(
  ...
  describe('Resource Errors', () => {
    ...
    it('should provide invalid resource key message', () => {
      expect(ErrorMessages.INVALID_RESOURCE_KEY).toBe(
  ...
  describe('Locale Errors', () => {
    ...
    it('should provide no locales configured message', () => {
      expect(ErrorMessages.NO_LOCALES_CONFIGURED).toBe(
  ...
  describe('File System Errors', () => {
    ...
    it('should provide file read failed message with reason', () => {
      ...
      ).toBe('❌ Failed to read file /path/to/file.json: Permission denied');
    });
    ...
    it('should provide file write failed message with reason', () => {
      expect(
        ErrorMessages.FILE_WRITE_FAILED('/path/to/file.json', 'Disk full'),
      ).toBe('❌ Failed to write file /path/to/file.json: Disk full');
    });
  });
});
